...
namespace KatmanliMimari.Web.Api.ApiService
{
    public class ProductApiService
    {
        ...
        public async Task<ProductDto> AddAsync(ProductDto productDto)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                productDto = JsonConvert.DeserializeObject<ProductDto>(
                    await response.Content.ReadAsStringAsync());
                return productDto;
            }
            else
        ...
        {
            var stringContent = new StringContent(JsonConvert.SerializeObject(productDto),
